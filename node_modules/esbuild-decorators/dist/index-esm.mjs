...
import { transpileModule, findConfigFile, sys, parseConfigFileTextToJson, parseJsonConfigFileContent } from 'typescript';
...
const esbuildDecorators = (options = {}) => ({
    ...
    setup(build) {
        ...
        const tsconfigPath = options.tsconfig || ((_a = build.initialOptions) === null || _a === void 0 ? void 0 : _a.tsconfig) || join(cwd, './tsconfig.json');
